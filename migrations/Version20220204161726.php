 ...
 */
final class Version20220204161726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scpi ADD localisation VARCHAR(255) NOT NULL, ADD assurance_vie TINYINT(1) NOT NULL');
    }
