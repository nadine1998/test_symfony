...
class SocieteDeGestionController extends AbstractController
{
    ...
    public function index(SocieteDeGestionRepository $societeDeGestionRepository): Response
    {
        return $this->render('societe_de_gestion/index.html.twig', [
            'societe_de_gestions' => $societeDeGestionRepository->findAll(),
        ]);
    }
    ...
    public function show(SocieteDeGestion $societeDeGestion): Response
    {
    ...
    public function edit(Request $request, SocieteDeGestion $societeDeGestion, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(SocieteDeGestionType::class, $societeDeGestion);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, SocieteDeGestion $societeDeGestion, EntityManagerInterface $entityManager): Response
    {
